...
public class GameFieldTests {
    ...
    public void testGetScore(GameField.Direction dir, int expected) {
        ...
        field.move(dir);
        Assertions.assertEquals(expected, field.getScore());
    }
    
    private static Stream<Arguments> getScoreProvider() {
        return Stream.of(
                Arguments.of(GameField.Direction.LEFT, 4),
                Arguments.of(GameField.Direction.DOWN, 16)
        );
    }
